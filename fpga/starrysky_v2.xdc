...
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS18} [get_ports cust_psram_sio0_io] 
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS18} [get_ports cust_psram_sio1_io]
