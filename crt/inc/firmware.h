...
#define reg_i2s_format     (*(volatile uint32_t*)0x10007004)
#define reg_i2s_upbound    (*(volatile uint32_t*)0x10007008)
#define reg_i2s_lowbound   (*(volatile uint32_t*)0x1000700C)
#define reg_i2s_recven     (*(volatile uint32_t*)0x10007010)
...
// sdram
#define reg_sdram_clkdiv     (*(volatile uint32_t*)0x1000D000)
#define reg_sdram_cfg        (*(volatile uint32_t*)0x1000D004)
// dvp
