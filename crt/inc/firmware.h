...
// qspi
#define reg_qspi_status    (*(volatile uint32_t*)0x20007000)
#define reg_qspi_clkdiv    (*(volatile uint32_t*)0x20007004)
#define reg_qspi_cmd       (*(volatile uint32_t*)0x20007008)
#define reg_qspi_adr       (*(volatile uint32_t*)0x2000700c)
#define reg_qspi_len       (*(volatile uint32_t*)0x20007010)
#define reg_qspi_dum       (*(volatile uint32_t*)0x20007014)
#define reg_qspi_txfifo    (*(volatile uint32_t*)0x20007018)
#define reg_qspi_rxfifo    (*(volatile uint32_t*)0x20007020)
#define reg_qspi_intcfg    (*(volatile uint32_t*)0x20007024)
#define reg_qspi_intsta    (*(volatile uint32_t*)0x20007028)
