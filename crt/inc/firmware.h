...
#define reg_qspi0_clkdiv    (*(volatile uint32_t*)0x10009004)
#define reg_qspi0_upbound   (*(volatile uint32_t*)0x10009008)
#define reg_qspi0_lowbound  (*(volatile uint32_t*)0x1000900C)
#define reg_qspi0_cmdtyp    (*(volatile uint32_t*)0x10009010)
#define reg_qspi0_cmdlen    (*(volatile uint32_t*)0x10009014)
#define reg_qspi0_cmddat    (*(volatile uint32_t*)0x10009018)
#define reg_qspi0_adrtyp    (*(volatile uint32_t*)0x1000901C)
#define reg_qspi0_adrlen    (*(volatile uint32_t*)0x10009020)
#define reg_qspi0_adrdat    (*(volatile uint32_t*)0x10009024)
#define reg_qspi0_dumtyp    (*(volatile uint32_t*)0x10009028)
#define reg_qspi0_dumlen    (*(volatile uint32_t*)0x1000902C)
#define reg_qspi0_dumdat    (*(volatile uint32_t*)0x10009030)
#define reg_qspi0_dattyp    (*(volatile uint32_t*)0x10009034)
#define reg_qspi0_datlen    (*(volatile uint32_t*)0x10009038)
#define reg_qspi0_txdata    (*(volatile uint32_t*)0x1000903C)
#define reg_qspi0_rxdata    (*(volatile uint32_t*)0x10009040)
#define reg_qspi0_hlvlen    (*(volatile uint32_t*)0x10009044)
#define reg_qspi0_start     (*(volatile uint32_t*)0x10009048)
#define reg_qspi0_status    (*(volatile uint32_t*)0x1000904C)
