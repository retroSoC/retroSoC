...
#define RS_SYSCTRL_PERF_USB2_WAIT_LO_OFFSET        RS_SOC_SYSCTRL_PERF_USB2_WAIT_LO_OFFSET
#define RS_SYSCTRL_PERF_USB2_WAIT_HI_OFFSET        RS_SOC_SYSCTRL_PERF_USB2_WAIT_HI_OFFSET
...
static rs_status_t rs_sysctrl_perf_offsets(rs_sysctrl_perf_counter_t counter, uint32_t *low_offset,
    ...
    case RS_SYSCTRL_PERF_SDIO1_WAIT:
        ...
        *high_offset = RS_SYSCTRL_PERF_SDIO1_WAIT_HI_OFFSET;
        break;
    case RS_SYSCTRL_PERF_USB2_WAIT:
        *low_offset = RS_SYSCTRL_PERF_USB2_WAIT_LO_OFFSET;
        *high_offset = RS_SYSCTRL_PERF_USB2_WAIT_HI_OFFSET;
        break;
