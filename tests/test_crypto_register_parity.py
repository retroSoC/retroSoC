...
def test_crypto_register_offsets_match_rtl() -> None:
    ...
    mapping = {
        ...
        "APB4_CRYPTO__MEM_STATUS": "RS_CRYPTO_REG_MEM_STATUS",
        "APB4_CRYPTO__MEM_CONTROL": "RS_CRYPTO_REG_MEM_CONTROL",
        "APB4_CRYPTO__TABLE_ID": "RS_CRYPTO_REG_TABLE_ID",
        "APB4_CRYPTO__TABLE_WORDS": "RS_CRYPTO_REG_TABLE_WORDS",
        "APB4_CRYPTO__TABLE_DATA": "RS_CRYPTO_REG_TABLE_DATA",
        "APB4_CRYPTO__TABLE_CRC": "RS_CRYPTO_REG_TABLE_CRC",
        "APB4_CRYPTO__MEM_ERROR": "RS_CRYPTO_REG_MEM_ERROR",
        "APB4_CRYPTO__MEM_CYCLES": "RS_CRYPTO_REG_MEM_CYCLES",
...
def test_crypto_register_fields_match_rtl() -> None:
    ...
    mapping = {
        ...
        "APB4_CRYPTO__IRQ_MEMORY_READY": "RS_CRYPTO_IRQ_MEMORY_READY",
        "APB4_CRYPTO__ERROR_MEMORY": "RS_CRYPTO_ERROR_MEMORY",
        "APB4_CRYPTO__STATUS_MAINTENANCE_BUSY": "RS_CRYPTO_STATUS_MAINTENANCE_BUSY",
        "APB4_CRYPTO__STATUS_READY": "RS_CRYPTO_STATUS_READY",
        "APB4_CRYPTO__CAPABILITY0_STORAGE_INIT": "RS_CRYPTO_CAP_STORAGE_INIT",
        "APB4_CRYPTO__CAPABILITY0_SRAM_MACRO": "RS_CRYPTO_CAP_SRAM_MACRO",
        "APB4_CRYPTO__MEM_STATUS_READY": "RS_CRYPTO_MEM_STATUS_READY",
        "APB4_CRYPTO__MEM_STATUS_TABLE_VALID": "RS_CRYPTO_MEM_STATUS_TABLE_VALID",
        "APB4_CRYPTO__MEM_STATUS_SCRUB_BUSY": "RS_CRYPTO_MEM_STATUS_SCRUB_BUSY",
        "APB4_CRYPTO__MEM_STATUS_LOAD_ACTIVE": "RS_CRYPTO_MEM_STATUS_LOAD_ACTIVE",
        "APB4_CRYPTO__MEM_STATUS_VERIFY_BUSY": "RS_CRYPTO_MEM_STATUS_VERIFY_BUSY",
        "APB4_CRYPTO__MEM_STATUS_TABLE_LOCKED": "RS_CRYPTO_MEM_STATUS_TABLE_LOCKED",
        "APB4_CRYPTO__MEM_STATUS_FAULT": "RS_CRYPTO_MEM_STATUS_FAULT",
        "APB4_CRYPTO__MEM_CONTROL_BEGIN": "RS_CRYPTO_MEM_CONTROL_BEGIN",
        "APB4_CRYPTO__MEM_CONTROL_COMMIT": "RS_CRYPTO_MEM_CONTROL_COMMIT",
        "APB4_CRYPTO__MEM_CONTROL_CANCEL": "RS_CRYPTO_MEM_CONTROL_CANCEL",
    }
    shift_names = {
...
def test_crypto_v2_contract_constants_match_rtl() -> None:
    rtl = _rtl_values()
    c = _c_values()
    for name in ("IP_ID_VALUE", "IP_VERSION_VALUE", "TABLE_ID_VALUE", "TABLE_CRC_VALUE",
                 "TABLE_WORD_COUNT", "MEM_ERROR_CODE_MASK", "MEM_ERROR_BANK_MASK",
                 "MEM_ERROR_ROW_MASK", "MEM_ERROR_VALID", "MEM_ERROR_BANK_SHIFT",
                 "MEM_ERROR_ROW_SHIFT", "MEM_ERROR_SEQUENCE", "MEM_ERROR_PADDING",
                 "MEM_ERROR_INPUT_CRC", "MEM_ERROR_READBACK_CRC", "MEM_ERROR_SCRUB_VERIFY",
                 "MEM_ERROR_WATCHDOG"):
        assert rtl[f"APB4_CRYPTO__{name}"] == c[f"RS_CRYPTO_{name}"]
