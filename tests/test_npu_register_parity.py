...
SCALARS = {
    ...
    "APB4_NPU__CAPABILITY_P2": "RS_NPU_CAPABILITY_P2",
...
C_ONLY_SCALARS = (
    ...
    "RS_NPU_LOCAL_BYTES_VALUE",
    "RS_NPU_MAC_CONFIG_VALUE",
    "RS_NPU_MAX_K_SLICE",
    "RS_NPU_MAX_DIMENSION",
    "RS_NPU_MAX_TILE",
    "RS_NPU_OP_CAPABILITY_MVP",
...
def test_npu_register_offsets_and_scalar_encodings_are_exhaustive() -> None:
    ...
    assert rtl["APB4_NPU__CAPABILITY_P2"] == 0x00000009
    ...
    assert c["RS_NPU_LOCAL_BYTES_VALUE"] == 65536
    assert c["RS_NPU_MAC_CONFIG_VALUE"] == 0x00080040
