    ...
    source_list.write_text(
        "\n".join(
            [
                ...
                str(ROOT / "rtl/ip/native/memory/sdram.sv"),
                str(ROOT / "rtl/ip/native/memory/sdram_clkgen.sv"),
                str(ROOT / "rtl/ip/native/memory/sdram_reg.sv"),
                str(ROOT / "rtl/ip/native/memory/sdram_core.sv"),
