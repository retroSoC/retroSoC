    ...
    source_list.write_text(
        "\n".join(
            [
                ...
                str(ROOT / "rtl/ip/rib/memory/sdram.sv"),
                str(ROOT / "rtl/ip/rib/memory/sdram_clkgen.sv"),
                str(ROOT / "rtl/ip/rib/memory/sdram_reg.sv"),
                str(ROOT / "rtl/ip/rib/memory/sdram_core.sv"),
