...
module fabric_monitor_tb;
  logic             clk_i = 1'b0;
  logic             rst_n_i = 1'b0;
  logic [ 8:0]      master_read_accept_i = '0;
  logic [ 8:0]      master_write_accept_i = '0;
  logic [ 8:0]      master_read_beat_i = '0;
  logic [ 8:0]      master_write_beat_i = '0;
  logic [ 8:0]      master_wait_i = '0;
  logic [ 8:0]      master_promotion_i = '0;
  logic [ 8:0][2:0] master_read_outstanding_i = '0;
  logic [ 8:0][2:0] master_write_outstanding_i = '0;
  ...
  initial begin
    ...
    if (read_data != 32'h0609_0003) $fatal(1, "fabric monitor capability mismatch");
