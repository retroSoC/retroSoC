...
module rib_burst_bus_tb;
  ...
  initial begin
    ...
    issue_read(32'h3800_1000, `SOC_RIB_BURST_INCR4, 1'b0);
    if (rib_command_count != 1) begin
      $fatal(1, "INCR4 was split before reaching the burst RIB target");
    end
    issue_read(32'h3800_1004, `SOC_RIB_BURST_INCR4, 1'b1);
    issue_read(32'h1000_0000, `SOC_RIB_BURST_INCR4, 1'b1);
    issue_read(32'h2000_0000, `SOC_RIB_BURST_INCR4, 1'b1);
    issue_read(32'h3800_1000, 2'd2, 1'b1);
    if (rib_command_count != 1 || apb_rib.valid) begin
