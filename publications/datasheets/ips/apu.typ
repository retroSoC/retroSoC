...
#import "../diagram-packages.typ": apu-instruction-diagram
...
#ip-reference("apu","apu",4,functional-note:[
  #block(breakable:false)[
    #change-start("apu-instruction-layout", "APU internal microcode format and encoding examples", category:"added")
    ...
    #change-end("apu-instruction-layout")
  ]
],legacy:[
