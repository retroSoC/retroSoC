...
.PHONY: help config doctor setup setup-regression setup-mpw setup-clusterip setup-ip setup-pdk setup-app \
	...
	formal formal-bus formal-rib-adapter formal-rib2apb formal-ws2812 formal-clean formal-doctor
.NOTPARALLEL: setup
...
help:
	@printf '%s\n' \
	  ...
	  '  formal-sysctrl | formal-pll-rcu | formal-gpio-user | formal-ws2812 run peripheral proofs' \
