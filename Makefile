...
.PHONY: help config doctor setup setup-mpw setup-core setup-clusterip setup-ip setup-pdk setup-app \
	...
	formal formal-bus formal-rib-adapter formal-spill-register formal-rib2apb formal-clean formal-doctor
.NOTPARALLEL: setup
...
help:
	@printf '%s\n' \
	  ...
	  '  formal | formal-bus | formal-rib-adapter | formal-spill-register | formal-rib2apb run SBY protocol proofs' \
