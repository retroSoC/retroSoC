...
module user_ip_top (
  ...
  // ====== GENERATED BY SCRIPT ======
  // verilog_format: off
  user_gpio_if #(`USER_GPIO_NUM) u_user_1_gpio_if();
  user_gpio_if #(`USER_GPIO_NUM) u_user_2_gpio_if();
  ...
  always_comb begin
    ...
    unique case (sel_i)
      8'd1: begin
        // gpio
        gpio.do_o               = u_user_1_gpio_if.do_o;
        gpio.oe_o               = u_user_1_gpio_if.oe_o;
        // apb
      ...
      8'd2: begin
        // gpio
        gpio.do_o               = u_user_2_gpio_if.do_o;
        gpio.oe_o               = u_user_2_gpio_if.oe_o;
        // apb
  ...
  assign u_user_1_gpio_if.di_i = gpio.di_i;
  assign u_user_2_gpio_if.di_i = gpio.di_i;
