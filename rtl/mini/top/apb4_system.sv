...
module apb4_system (
    ...
    input  logic [9:0]                            resource_idle_i,
    input  logic [9:0]                            resource_block_ack_i,
    input  logic [8:0]                            resource_irq_i,
    ...
    output logic [9:0][1:0]                       resource_owner_o,
    output logic [9:0]                            resource_owner_lock_o,
    output logic [9:0]                            resource_quiesce_o,
    output logic [9:0]                            resource_reset_o,
    output logic [8:0]                            resource_irq_lp_o,
    output logic [8:0]                            resource_irq_hp_o,
...
`endif
  ...
  logic [ 9:0]      s_resource_irq;
  logic [ 9:0]      s_resource_irq_lp;
  logic [ 9:0]      s_resource_irq_hp;
...
`endif
  ...
  assign s_resource_irq = {
    resource_irq_i[8], resource_irq_i[7], resource_irq_i[6:5], s_ext_h_irq_raw, resource_irq_i[4:0]
  };
  ...
  assign resource_irq_lp_o = {
    s_resource_irq_lp[9], s_resource_irq_lp[8], s_resource_irq_lp[7:6], s_resource_irq_lp[4:0]
  };
  assign resource_irq_hp_o = {
    s_resource_irq_hp[9], s_resource_irq_hp[8], s_resource_irq_hp[7:6], s_resource_irq_hp[4:0]
  };
...
`endif
  ...
  assign s_unused_resource = ^{unused_ext_h_owner, s_resource_irq_hp[5]};
