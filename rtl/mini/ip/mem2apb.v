module mem2apb #(
  ...
  assign apb_psel_o[0] = mem_valid_i && (mem_addr_i[31:24] == 8'h03 && mem_addr_i[15:8] == 8'h10);
  assign apb_psel_o[1] = mem_valid_i && (mem_addr_i[31:24] == 8'h03 && mem_addr_i[15:8] == 8'h20);
  assign apb_psel_o[2] = mem_valid_i && (mem_addr_i[31:24] == 8'h03 && mem_addr_i[15:8] == 8'h30);
  assign apb_psel_o[3] = mem_valid_i && (mem_addr_i[31:24] == 8'h03 && mem_addr_i[15:8] == 8'h40);
  assign apb_psel_o[4] = mem_valid_i && (mem_addr_i[31:24] == 8'h03 && mem_addr_i[15:8] == 8'h50);
  assign apb_psel_o[5] = mem_valid_i && (mem_addr_i[31:24] == 8'h03 && mem_addr_i[15:8] == 8'h60);
  assign apb_psel_o[6] = mem_valid_i && (mem_addr_i[31:24] == 8'h03 && mem_addr_i[15:8] == 8'h70);
  assign apb_psel_o[7] = mem_valid_i && (mem_addr_i[31:24] == 8'h30);
