...
// reset --- Global (power-on) reset (active high)
// SCK ---   Clock input
// SDI ---   Data  input
// SDO ---   Data  output
...
// 11000100  Pass-through read/write until CSB raised
...
module spi_slave (
  ...
  assign SDO             = ldata[7];
  assign csb_reset       = CSB | reset;  // Reset either on CSB or global reset
