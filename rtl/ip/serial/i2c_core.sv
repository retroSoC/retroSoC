...
module i2c_core (
  ...
  logic s_cmd_active_d, s_cmd_active_q;
  ...
  assign s_cmd_timeout = timeout_expired(s_cmd_count_q, command_timeout_i);
  assign s_arbitration_lost = (s_bit_action_q == BIT_TX) && s_tx_bit && !sda_i;

  assign busy_o = (s_fsm_q != FSM_IDLE) || s_cmd_active_q || s_recovery_q;
    ...
    unique case (s_fsm_q)
      ...
      FSM_BIT_LOW, FSM_BIT_HIGH_WAIT, FSM_BIT_HIGH: begin
        ...
        unique case (s_bit_action_q)
          ...
          BIT_CONTROLLER_ACK: sda_pull_low_o = !s_cmd_q[11] && !s_rx_overflow_q;
  ...
  always_comb begin
    ...
    end else if (s_cmd_timeout && (s_fsm_q != FSM_IDLE) && !s_recovery_q &&
      ...
      unique case (s_fsm_q)
        ...
        FSM_START_HOLD: begin
          if (timing_expired(s_phase_count_q, start_hold_cycles_i)) begin
            ...
            if (!ten_bit_i) begin
              s_tx_byte_d   = {target_addr_i[6:0], s_cmd_q[8]};
            ...
            if ((s_bit_action_q == BIT_TX) || (s_bit_action_q == BIT_RX)) begin
                ...
                unique case (s_byte_role_q)
                  ...
                  BYTE_WRITE: begin
                    ...
                    if (s_cmd_q[10]) begin
                      ...
                      s_cmd_count_d  = '0;
                      cmd_pop_o      = 1'b1;
                      if (cmd_data_i[9] || (cmd_data_i[8] != s_cmd_q[8])) begin
                        s_read_header_only_d = 1'b0;
                        s_fsm_d              = FSM_RESTART_LOW;
                      end else begin
              ...
              if (s_rx_overflow_q) begin
                ...
                if (s_cmd_q[10]) begin
                  ...
                  if (s_cmd_q[11] && !cmd_data_i[9]) begin
                    cmd_flush_o           = 1'b1;
                    command_error_event_o = 1'b1;
                    s_fsm_d               = FSM_STOP_LOW;
                  end else begin
  ...
  dffr #(
      .DATA_WIDTH(1)
  ) u_command_active_dffr (
      .clk_i  (clk_i),
      .rst_n_i(rst_n_i),
      .dat_i  (s_cmd_active_d),
      .dat_o  (s_cmd_active_q)
  );
