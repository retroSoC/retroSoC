...
module i2s_reg (
  ...
  assign s_i2s_mode_en  = s_rib_wr_hdshk && rib.addr[7:0] == `RIB_I2S_MODE;
  assign s_i2s_mode_d   = rib.wdata[0];
  ...
  assign s_i2s_format_en = s_rib_wr_hdshk && rib.addr[7:0] == `RIB_I2S_FORMAT;
  assign s_i2s_format_d  = rib.wdata[1:0];
  ...
  assign s_i2s_upbound_en = s_rib_wr_hdshk && rib.addr[7:0] == `RIB_I2S_UPBOUND;
  assign s_i2s_upbound_d  = rib.wdata[7:0];
  ...
  assign s_i2s_lowbound_en = s_rib_wr_hdshk && rib.addr[7:0] == `RIB_I2S_LOWBOUND;
  assign s_i2s_lowbound_d  = rib.wdata[7:0];
  ...
  assign s_i2s_recven_en = s_rib_wr_hdshk && rib.addr[7:0] == `RIB_I2S_RECVEN;
  assign s_i2s_recven_d  = rib.wdata[0];
  ...
  always_comb begin
    ...
    tx_push_data_o  = '0;
    if (s_rib_wr_hdshk && rib.addr[7:0] == `RIB_I2S_TXDATA) begin
  ...
  always_comb begin
    ...
    unique case (rib.addr[7:0])
      `RIB_I2S_MODE:   s_rib_rdata_d = {31'd0, s_i2s_mode_q};
      `RIB_I2S_FORMAT: s_rib_rdata_d = {30'd0, s_i2s_format_q};
      `RIB_I2S_RXDATA: begin
      ...
      `RIB_I2S_STATUS: s_rib_rdata_d = {30'd0, s_i2s_status_q};
