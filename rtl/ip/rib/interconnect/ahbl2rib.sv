...
module ahbl2rib (
      ...
      unique case (s_hsize_q)
        AHBL_SIZE_BYTE: begin
          unique case (s_haddr_q[1:0])
            2'b00: begin
              rib.wstrb = 4'b0001;
              rib.wdata = {24'b0, ahbl.hwdata[7:0]};
            end
            2'b01: begin
              rib.wstrb = 4'b0010;
              rib.wdata = {16'b0, ahbl.hwdata[7:0], 8'b0};
            end
            2'b10: begin
              rib.wstrb = 4'b0100;
              rib.wdata = {8'b0, ahbl.hwdata[7:0], 16'b0};
            end
            2'b11: begin
              rib.wstrb = 4'b1000;
              rib.wdata = {ahbl.hwdata[7:0], 24'b0};
            end
            default: begin
              rib.wstrb = 4'b0001;
              rib.wdata = {24'b0, ahbl.hwdata[7:0]};
        ...
        AHBL_SIZE_HWRD: begin
          unique case (s_haddr_q[1])
            1'b0: begin
              rib.wstrb = 4'b0011;
              rib.wdata = {16'b0, ahbl.hwdata[15:0]};
            end
            1'b1: begin
              rib.wstrb = 4'b1100;
  ...
  always_comb begin
    ...
    unique case (s_fsm_q)
      ...
      STATE_DATA: begin
        if (~rib.ready) s_fsm_d = STATE_WAIT;
        // rib.ready == 1'b1
