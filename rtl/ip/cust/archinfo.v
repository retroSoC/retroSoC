...
module apb4_archinfo (
  ...
  assign prdata = ~s_apb4_rd_hdshk ? 32'h0 :
                  s_apb4_addr == `ARCHINFO_SYS ? {12'h0, s_arch_sys_q} :
                  s_apb4_addr == `ARCHINFO_IDL ? s_arch_idl_q :
                  s_apb4_addr == `ARCHINFO_IDH ? {8'h0, s_arch_idh_q} : 32'h0;
