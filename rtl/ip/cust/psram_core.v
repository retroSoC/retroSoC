module psram_core (
  ...
  assign mem_rdata_o    = ({32{xfer_data_bit_cnt_i == 8'd32}} & (r_xfer_data & 32'hFFFF_FFFF)) |
                          ({32{xfer_data_bit_cnt_i == 8'd16}} & (r_xfer_data & 32'h0000_FFFF)) |
                          ({32{xfer_data_bit_cnt_i == 8'd8 }} & (r_xfer_data & 32'h0000_00FF));
