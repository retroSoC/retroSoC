...
`define NATV_SPISD_START  8'h14
`define NATV_SPISD_STATUS 8'h18
// verilog_format: on
...
module spisd_reg (
  ...
  always_comb begin
    ...
    unique case (nmi.addr[7:0])
      ...
      `NATV_SPISD_ADDR:   s_nmi_rdata_d = '0;
      `NATV_SPISD_RXDATA: s_nmi_rdata_d = '0;
      `NATV_SPISD_STATUS: s_nmi_rdata_d = '0;
