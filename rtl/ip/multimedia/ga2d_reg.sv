...
module ga2d_reg (
  ...
  always_comb begin
    ...
    unique case (s_offset)
      ...
      `APB4_GA2D__CAPABILITY: s_read_data = `APB4_GA2D__CAPABILITY_P3;
      `APB4_GA2D__LIMITS: s_read_data = `APB4_GA2D__LIMITS_P3;
      `APB4_GA2D__STATUS:
      s_read_data = {
        24'd0,
        recovery_required_i,
      ...
      `APB4_GA2D__FORMAT_CAPABILITY: s_read_data = `APB4_GA2D__FORMAT_CAPABILITY_P3;
      `APB4_GA2D__SNAP_CYCLES_LO,
      `APB4_GA2D__SNAP_CYCLES_HI,
      `APB4_GA2D__SNAP_READ_BYTES_LO,
      `APB4_GA2D__SNAP_READ_BYTES_HI,
      `APB4_GA2D__SNAP_WRITE_BYTES_LO,
      `APB4_GA2D__SNAP_WRITE_BYTES_HI,
      `APB4_GA2D__SNAP_READ_STALL_LO,
      `APB4_GA2D__SNAP_READ_STALL_HI,
      `APB4_GA2D__SNAP_WRITE_STALL_LO,
      `APB4_GA2D__SNAP_WRITE_STALL_HI,
      `APB4_GA2D__SNAP_PIPE_STALL_LO,
      `APB4_GA2D__SNAP_PIPE_STALL_HI,
      `APB4_GA2D__SNAP_LINES_DONE,
      `APB4_GA2D__COMMAND,
      `APB4_GA2D__IRQ_TEST,
        ...
        unique case (s_offset)
          `APB4_GA2D__COMMAND: begin
            unique case (s_write_value)
              ...
              32'h0000_0001: s_write_err = 1'b1;
              32'h0000_0002: s_cmd_abort = 1'b1;
              32'h0000_0004: begin
          ...
          `APB4_GA2D__PERF_SNAPSHOT: s_write_err = 1'b1;
          default:                   s_write_err = 1'b1;
        endcase
      end
    end
