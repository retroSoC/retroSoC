...
module apu_reg (
  ...
  localparam logic [31:0] Capability0 = 32'd0;
  ...
  always_comb begin
    ...
    if (!s_read_err) begin
      unique case (s_offset)
        ...
        `APB4_APU__STATUS: s_read_data = {22'd0, 1'b0, 1'b1, 1'b0, quiesce_i, 6'd0};
        ...
        `APB4_APU__STREAM_STATUS: s_read_data = 32'd0;
    ...
    if (!s_write_err) begin
      unique case (s_offset)
        `APB4_APU__COMMAND: begin
          s_write_unsupported = (apb4.pwdata & 32'h0000_003b) != 32'd0;
        ...
        `APB4_APU__SEQUENCER_TIMEOUT: begin
          ...
          s_write_err    = s_merged_write == 32'd0;
        end
        ...
        `APB4_APU__JOB_INPUT_CONFIG: begin
          ...
          s_write_err    = s_merged_write[31:26] != 6'd0;
        end
        `APB4_APU__JOB_OUTPUT_CONFIG: begin
          s_merged_write = apply_wstrb(s_job_cfg_q[6], apb4.pwdata, apb4.pstrb);
          s_write_err    = (s_merged_write[31:21] != 11'd0) || (s_merged_write[20:19] > 2'd1);
        end
        `APB4_APU__JOB_FLAGS: begin
          s_merged_write = apply_wstrb(s_job_cfg_q[7], apb4.pwdata, apb4.pstrb);
          s_write_err    = s_merged_write[31:1] != 31'd0;
        end
        `APB4_APU__RING_BASE: s_write_err = (apb4.pstrb != 4'hf) || (apb4.pwdata[6:0] != 7'd0);
        `APB4_APU__RING_SIZE:
        s_write_err = (apb4.pstrb != 4'hf) || (apb4.pwdata < 32'd2) ||
                      (apb4.pwdata > 32'd256) || !is_power_of_two(apb4.pwdata);
        `APB4_APU__RING_TAIL: s_write_err = (apb4.pstrb != 4'hf) || (apb4.pwdata[31:8] != 24'd0);
        `APB4_APU__RING_CONTROL: s_write_err = (apb4.pstrb != 4'hf) || (apb4.pwdata[31:2] != 30'd0);
        ...
        `APB4_APU__KWS_CONTROL: begin
          ...
          s_write_err = (apb4.pstrb != 4'hf) || (apb4.pwdata[31:3] != 29'd0) || s_write_unsupported;
        end
        `APB4_APU__KWS_CONFIG: begin
          s_merged_write = apply_wstrb({16'd0, s_kws_cfg_q}, apb4.pwdata, apb4.pstrb);
          s_write_err    = (s_merged_write[31:16] != 16'd0) || (s_merged_write[15:8] == 8'd0);
        end
  ...
  always_comb begin
    ...
    if (s_write && !s_write_err) begin
      unique case (s_offset)
        ...
        `APB4_APU__IRQ_TEST:               s_irq_set = apb4.pwdata[10:0];
    ...
    if (s_soft_reset || resource_reset_i) begin
      s_irq_state_d           = 11'd0;
      s_irq_en_d              = 11'd0;
      s_err_stat_d            = 32'd0;
      s_err_addr_d            = 32'd0;
