...
| Property | Value |
| --- | --- |
| RIBP base address | `0x1000E000` |
| RIBP interrupt group bit | 13 |
...
The self-checking RTL test covers the versioned ABI, invalid RIBP accesses,
...
The SBY target proves RIBP response behavior, request/response progress,
